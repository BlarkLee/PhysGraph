...
class GrabDemoDexHand(ManipData):
    ...
    def __len__(self):
        print("len(self.data_pathes)", len(self.data_pathes))
    ...
    def __getitem__(self, idx):
        ...
        print("self.data_pathes[idx]", self.data_pathes[idx])
        print("os.path.join(self.data_dir, 102_obj.obj)", os.path.join(self.data_dir, "102_obj.obj"))
        ...
        #print("self.dexhand", self.dexhand)
        ...
        print("rs_verts_obj", rs_verts_obj.shape)
