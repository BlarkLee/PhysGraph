...
class Mano2Dexhand:
    ...
    def fitting(self, max_iter, obj_trajectory, target_wrist_pos, target_wrist_rot, target_mano_joints):
        ...
        offset = middle_pos - obj_pos # for collision safety
        ...
        while (self.headless and iter < max_iter) or (
            ...
            isaac_joints = torch.stack(
                ...
                dim=1,
            ) # [num_envs, num_joints, 3]

            # ret is a dictionary where each key is a body name and the value is a transformation matrix for that body
...
if __name__ == "__main__":
    ...
    def run(parser, idx):
        ...
        parser.num_envs = demo_data["mano_joints"].shape[0] #60
